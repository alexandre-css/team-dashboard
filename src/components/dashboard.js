...
const CALENDAR_ID =
    "c30807268699bd3ee379858bd2a143ad7d1b8aceacdcf20a9e138085cb70cad0@group.calendar.google.com";
...
const Dashboard = () => {
    ...
    const [mostrarFormularioNotebook, setMostrarFormularioNotebook] =
        useState(false);
    ...
    const carregarArquivosDrive = async () => {
        ...
        try {
            ...
            if (response.status === 403) {
                console.error(
                    "Erro 403: Verifique as permissões da API Key para Google Drive"
                );
                return;
            }
            ...
            const pastasPrincipais = arquivos.filter(
                (arquivo) =>
                    arquivo.mimeType.includes("folder") &&
                    (arquivo.name.toLowerCase().includes("livros") ||
                        arquivo.name.toLowerCase().includes("tutoriais"))
            );
            ...
            for (const pasta of pastasPrincipais) {
                ...
                try {
                    ...
                    console.error(
                        `Erro ao carregar conteúdo da pasta ${pasta.name}:`,
                        error
                    );
                    pasta.arquivos = [];
                }
            ...
            const todasAsPastas = arquivos.filter((arquivo) =>
                arquivo.mimeType.includes("folder")
            );

            setArquivosDrive({
                cardPrincipal: pastasPrincipais,
                todasPastas: todasAsPastas,
            });
        } catch (error) {
    ...
    const carregarEventosCalendario = async () => {
        ...
        try {
            ...
            const url = `https://www.googleapis.com/calendar/v3/calendars/${encodeURIComponent(
                CALENDAR_ID
            )}/events?key=${GOOGLE_API_KEY}&timeMin=${timeMin}&timeMax=${timeMax}&maxResults=50&singleEvents=true&orderBy=startTime`;
            ...
            if (response.status === 403) {
                console.error(
                    "Erro 403: Adicione localhost:3001 nas restrições da API Key"
                );
                return;
            }
    ...
    const carregarAvisos = async () => {
        try {
            ...
            const avisosProcessados = data.map((aviso) => ({
                ...aviso,
                imagens:
                    typeof aviso.imagens === "string"
                        ? JSON.parse(aviso.imagens)
                        : aviso.imagens || [],
            }));
        ...
        for (let item of items) {
            if (item.type.indexOf("image") !== -1) {
                ...
                reader.onload = (event) => {
                    setNovoAviso({
                        ...novoAviso,
                        imagens: [...novoAviso.imagens, event.target.result],
                    });
                };
    ...
    const handleImageDrop = (e) => {
        ...
        filesToProcess.forEach((file) => {
            ...
            reader.onload = (event) => {
                setNovoAviso((prev) => ({
                    ...prev,
                    imagens: [...prev.imagens, event.target.result],
                }));
            };
            reader.readAsDataURL(file);
        });
    ...
    const svgCoresPorTema = {
        claro: ["#2563eb", "#1e293b", "#64748b", "#3b82f6"],
        escuro: ["#60a5fa", "#334155", "#1e293b", "#0ea5e9"],
        vermelho: ["#ef4444", "#991b1b", "#ef4444", "#f87171"],
        verde: ["#10b981", "#065f46", "#10b981", "#34d399"],
        rosa: ["#ec4899", "#a21caf", "#ec4899", "#f472b6"],
        tjsc: ["#006837", "#004225", "#006837", "#4ade80"],
        black: ["#18181b", "#23232b", "#18181b", "#27272a"],
    };
    const coresSVG = svgCoresPorTema[tema] || svgCoresPorTema["claro"];
        ...
        <div className="dashboard">
            <div className="header-section">
                <div className="header-left">
                    ...
                    <div className="subtitle-container">
                        ...
                        <span className="desembargador-name">
                    ...
                    {mostrarMenuUsuario && (
                        ...
                        >
                            ...
                            <div className="user-menu-items">
                                ...
                                <div
                                    className="user-menu-item tema-submenu"
                                    onMouseEnter={() =>
                                        setMostrarSubmenuTemas(true)
                                    }
                                >
                                    <div className="menu-item-icon">
                                        <svg
                    ...
                    <div className="card avisos-card">
                        ...
                        <div className="card-content">
                            <div className="avisos-lista">
                                        ...
                                        <div className="rich-editor">
                                            ...
                                            <div
                                                ...
                                                dangerouslySetInnerHTML={{
                                                    __html: novoAviso.descricao,
                                                }}
                                            ></div>
                                        </div>
                                        <div className="image-upload">
                                            <label>
                                                Anexar imagens (máximo 3):
                                            </label>
                                            <div
                                            ...
                                            >
                                                {novoAviso.imagens.length >
                                                0 ? (
                                                    <div className="images-preview">
                                                        {novoAviso.imagens.map(
                                                            (img, index) => (
                                                                <div
                                                                    key={index}
                                ...
                                {avisos.map((aviso) => (
                                    <div
                                        className={`aviso-item ${aviso.tipo}`}
                                        key={aviso.id}
                                    >
                                        <div
                                            className={`aviso-dot ${aviso.tipo}`}
                                        ></div>
                                        <div className="aviso-text">
                                            <strong>{aviso.titulo}</strong>
                                            <div
                                                dangerouslySetInnerHTML={{
                                                    __html: aviso.descricao,
                                                }}
                                            />
                                            <div className="aviso-images">
                                                {aviso.imagens &&
                                                    aviso.imagens.length >
                                                        0 && (
                                                        <button
                                                            onClick={() =>
                                                                abrirGaleria(
                                ...
                                <div className="eventos-lista">
                                    {eventos.length > 0 ? (
                                        ...
                                        eventos.map((evento) => {
                                            ...
                                            const isUrgent = evento.summary
                                                .toLowerCase()
                                                .includes("limite");
                                            const isBirthday = evento.summary
                                                .toLowerCase()
                                                .includes("aniversário");
                                            const hasTime =
                                                evento.start.dateTime;
                                                        ...
                                                        <div className="evento-info-conteudo">
                                                            ...
                                                            {isBirthday ? (
                                                                <img
                                                                    src="/balloon.svg"
                                                                    alt="Aniversário"
                                                                    className="evento-status aniversario"
                                                                />
                                                            ) : (
                                                                <div
                        ...
                        <div className="card-content">
                            {carregandoDrive ? (
                                ...
                                <div className="arquivos-lista">
                                    {arquivosDrive.cardPrincipal?.map(
                                        (pasta) => (
                                            <div
                                                key={pasta.id}
                                                className="pasta-container"
                                            >
                                                <div
                                                            ...
                                                            {pasta.arquivos.map(
                                                                (arquivo) => (
                                                                    <div
                                                                        ...
                                                                        className="arquivo-item-submenu"
                                                                    >
                            ...
                            {mostrarFormularioNotebook && (
                                <div className="notebook-form">
                                    ...
                                    >
                                        ...
                                        {editandoNotebook && (
                                            <button
                                                onClick={cancelarEdicaoNotebook}
                                                className="form-cancel"
                                            >
                                                Cancelar
                                            </button>
                                ...
                                >
                                    <div className="notebook-item">
                                        ...
                                        <div className="notebook-content">
                                            <h4 className="notebook-titulo">
                                                {notebook.titulo}
                                            </h4>
                                            <p className="notebook-descricao">
                                                {notebook.descricao}
                                            </p>
                                        </div>
                        ...
                        <div className="card-content">
                            {tjscLinks.map((link) => (
                                ...
                                >
                                    ...
                                    >
                                        <span className="tjsc-icon">
                                            {getIconComponent(link.icone)}
                                        </span>
                                        <span className="tjsc-text">
                                            {link.titulo}
                                        </span>
                                    </a>
                                    {((link.user_id &&
            ...
            {mostrarGaleria && (
                <div className="modal-overlay" onClick={fecharGaleria}>
                    ...
                    >
                        <button className="modal-close" onClick={fecharGaleria}>
                            ×
                        </button>
